...
### Local Diagnostics
44. Queue-panel-specific interactions (edit committed, row deleted, row reordered, panel collapsed/expanded) stay local UI behavior in this fork and do not emit product telemetry.
