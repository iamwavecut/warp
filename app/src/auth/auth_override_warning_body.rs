...
const AUTH_OVERRIDE_DESCRIPTION: &str = "It looks like you logged into a Warp account through a web browser. Hosted login is disabled in this local-first build; continuing would replace local session data and preferences.";
...
const AUTH_OVERRIDE_CONFIRM_CONFIRMATION_STEP_HEADER: &str =
    "Replace local session data and preferences?";
