...
static DEFAULT_TIPS: LazyLock<Vec<AgentTip>> = LazyLock::new(|| {
    vec![
        ...
        AgentTip {
            description: "`@` to add context from files, blocks, or local objects to your prompt.".to_string(),
            link: None,
            binding_name: None,
            action: None,
        ...
        AgentTip {
            description: "`/open-mcp-servers` to view local MCP servers.".to_string(),
            link: None,
            binding_name: None,
            action: None,
            kind: AgentTipKind::Mcp,
...
impl WorkspaceAction {
    pub fn display_text(&self) -> Option<String> {
        match self {
            ...
            WorkspaceAction::OpenWarpDrive => Some("Local library".to_string()),
