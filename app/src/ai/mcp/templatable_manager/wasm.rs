...
impl TemplatableMCPServerManager {
    ...
    /// Updates a local TemplatableMCPServer.
    ///
    ...
    /// Gets all local TemplatableMCPServers.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Creates a new local TemplatableMCPServer.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Deletes a local TemplatableMCPServer.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    pub fn get_all_local_template_mcp_servers(_ctx: &AppContext) -> HashMap<Uuid, String> {
        Default::default()
    }
