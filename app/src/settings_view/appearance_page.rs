...
use super::settings_page::{
    AdditionalInfo, CONTENT_FONT_SIZE, Category, LocalOnlyIconState, MatchData, PageType,
    SettingsWidget,
};
...
use crate::settings::{
    ...
    PaneSettings, ShouldDimInactivePanes, ThemeSettings, UseSystemTheme, active_theme_kind,
...
use warpui::platform::{Cursor, FilePickerConfiguration, GraphicsBackend, WindowBackdrop};
...
impl AppearanceSettingsPageView {
        ...
        let alt_screen_padding_editor = {
            ...
            ctx.add_typed_action_view(|ctx| {
                    ...
                    *TerminalSettings::as_ref(ctx).alt_screen_padding
                {
                    ...
                    // Do a system edit to avoid counting this update as part of diagnostics.
    ...
    fn build_page(ctx: &mut ViewContext<Self>) -> PageType<Self> {
        ...
        // Tools panel tab visibility toggles. These mirror the onboarding "Customize
        ...
        // of the corresponding local tab, so the section stays stable regardless
        // of when the page is built.
