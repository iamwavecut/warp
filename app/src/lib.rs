...
use warpui::{App, Event, integration::TestDriver};
...
impl LaunchMode {
    ...
    fn execution_mode(&self) -> ExecutionMode {
        match self {
            ...
            // RemoteServerDaemon gets its own mode for process classification.
...
pub(crate) fn initialize_app(
    ...
    });
    {
        ...
        // Also revalidate when workspace/team policy data changes.
