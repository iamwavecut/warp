...
- Author environment limitations (e.g., headless runner or no desktop) do not exempt a change that explicitly required visual proof. Ask for evidence from a local desktop run without recommending a hosted agent or cloud computer-use service.
