...
impl RemoteServerErrorKind {
    /// Classify a [`ClientError`] into a diagnostic error kind.
...
pub enum RemoteServerManagerEvent {
    ...
    SessionConnectionFailed {
        ...
        /// Used by diagnostics to distinguish proxy crashes from other failures.
        exit_status: Option<RemoteServerExitStatus>,
        ...
        /// that only care about real failures (e.g. diagnostics, UI
    ...
    SessionDisconnected {
        ...
        /// reconnect-exhausted diagnostics from regular disconnections.
...
impl RemoteServerManager {
            ...
            .spawn(async move {
                    ...
                    .await
                {
                    ...
                    Err(e) => {
                        ...
                        // Transport-level diagnostics are emitted automatically
    ...
    fn mark_session_connected(
        ...
        // Drain the separate failure channel for request-failed diagnostics.
