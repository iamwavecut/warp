...
pub enum RemoteServerManagerEvent {
    ...
    SessionDisconnected {
        ...
        /// reconnect-exhausted disconnects from regular disconnections.
...
impl RemoteServerManager {
            ...
            .spawn(async move {
                ...
                match mutation.send(client, repo_path, auth_token).await {
                    ...
                    Err(e) => {
                        ...
                        // Transport-level request failures are emitted automatically
    ...
    fn mark_session_connected(
        ...
        // Drain the separate failure channel for request-failed notifications.
