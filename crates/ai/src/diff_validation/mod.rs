...
pub struct AIRequestedCodeDiff {
    ...
    /// Types of failures to create the diff that we want to capture via diagnostics.
...
pub struct DiffMatchFailures {
    ...
    /// Identifiers for blocks that failed to fuzzy match. Kept out of serialized summaries.
    #[serde(skip)]
