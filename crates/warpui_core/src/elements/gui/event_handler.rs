...
impl SelectableElement for EventHandler {
    fn get_selection(
        ...
        self.child
            ...
            .get_selection(selection_start, selection_end, is_rect)
    }
    ...
    fn expand_selection(
        ...
        self.child.as_selectable_element()?.expand_selection(
            point,
            direction,
            unit,
    ...
    fn smart_select(
        ...
        self.child
            .as_selectable_element()?
            .smart_select(absolute_point, smart_select_fn)
    }

    fn calculate_clickable_bounds(&self, current_selection: Option<Selection>) -> Vec<RectF> {
        self.child
            .as_selectable_element()
            .map(|child| child.calculate_clickable_bounds(current_selection))
            .unwrap_or_default()
    }
}
